        ...
        <footer className="pa4 pa5-l black-70 bt b--black-10">
            ...
            <div className="dt dt--fixed w-100">
                ...
                <div className="db dtc-ns black-70 tc tr-ns v-mid">
                    <a href="https://www.facebook.com/" className="link dim  mr3 black-70"
                        title="Impossible Labs on Facebook">
                        <svg className="db w2 h2" data-icon="facebook" viewBox="0 0 32 32" fill="currentColor" width="30" height="30">
                    ...
                    <a href="https://twitter.com/" className="link dim  mr3 black-70">
                        <svg className="db w2 h2 " data-icon="twitter" viewBox="0 0 32 32" fill="currentColor" width="30" height="30">
                    ...
                    <a href="https://medium.com/" className="link dim  mr3 black-70"
                        title="Impossible Labs on Medium">
                        <svg className="db w2 h2" x="0px" y="0px" viewBox="0 0 290 248.6" fill="currentColor" width="30" height="30">
                            <g>
                                ...
                                <polygon fill="currentColor" points="105.2,61.2 105.2,160.3 193.3,204.4   "></polygon>
                    ...
                    <a href="https://www.linkedin.com/company/" className="link dim  black-70">
                        <svg className="db w2 h2" x="0px" y="0px" viewBox="0 0 48 48" width="30" height="30">
                            <linearGradient gradientUnits="userSpaceOnUse" x1="23.9995" y1="0" x2="23.9995"
                                y2="48.0005">
                                <stop offset="0"></stop>
                                <stop offset="1"></stop>
                            </linearGradient>
