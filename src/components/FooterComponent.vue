        ...
        <footer className="pa4 pa5-l black-70 bt b--black-10">
            ...
            <div className="dt dt--fixed w-100">
                ...
                <div className="db dtc-ns black-70 tc tr-ns v-mid">
                    ...
                    <a href="mailto:sureshjha94@gmail.com" className="link dim  mr3 black-70"
                        title="Mail">
                    ...
                    <a href="https://www.linkedin.com/in/suresh-kumar-jha-767024191/" className="link dim  black-70">
